          ...
          <div style={{ maxWidth: 600, margin: '0 auto' }}>
            <div className="lead-form">
              <div className="lead-form__success">
                ...
                <h3 className="lead-form__success-title">¡Bienvenido a eter!</h3>
                <p className="lead-form__success-text">
                  Hemos recibido tu solicitud. Nuestro equipo se pondrá en contacto contigo 
                  en las próximas 24 horas para configurar tu cuenta de prueba.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container">
        <div className="cta-section__inner">
          <ScrollAnimation>
            <div className="cta-section__content">
              ...
              <p className="cta-section__text">
                Únete a más de 50 negocios que ya optimizaron sus operaciones con eter. 
                Tu prueba gratis de 14 días comienza en 5 minutos.
              </p>
          ...
          <ScrollAnimation delay={2}>
            <form className="lead-form" onSubmit={handleSubmit} noValidate id="lead-form">
              <h3 className="lead-form__title">Únete a la beta</h3>

              <div className="lead-form__group">
                <label className="lead-form__label" htmlFor="name">Nombre completo</label>
                <input
              ...
              <div className="lead-form__group">
                <label className="lead-form__label" htmlFor="email">Correo electrónico</label>
                <input
              ...
              <div className="lead-form__group">
                <label className="lead-form__label" htmlFor="company">Empresa</label>
                <input
              ...
              <div className="lead-form__group">
                <label className="lead-form__label" htmlFor="industry">Industria</label>
                <select
              ...
              <div className="lead-form__group">
                <label className="lead-form__label" htmlFor="message">Mensaje (opcional)</label>
                <textarea
              ...
              <p style={{ 
                ...
                Al registrarte aceptas nuestros <a href="/terms" style={{ textDecoration: 'underline', color: 'var(--color-gray-400)' }}>Términos de Servicio</a> y <a href="/privacy" style={{ textDecoration: 'underline', color: 'var(--color-gray-400)' }}>Política de Privacidad</a>
              </p>
            </form>
          </ScrollAnimation>
        </div>
